        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('admin.homepage') }}" class="text-dark text-decoration-none"><i class="ti-arrow-left text-dark"></i></a>
                </div>
                <div class="card-body">
                ...
                <div class="card-footer">
                    <div class="row">
                        ...
                        <div class="col">
                            <button class="btn btn-primary mt-2 send"><i class="fa-regular fa-paper-plane"></i></button>
                        </div>
                    </div>
                </div>
            </div>
...
@section('scripts')
    ...
    <script>
        ...
        $(document).on('input', '.comment', function() {
            ...
            if (commentLength > 75) {
                $('#comment').replaceWith("<textarea class='form-control commetTextarea' type='text' id='comment' name='comment' rows='5'>" + currentValue + "</textarea>");
