...
<div class="row">
    <div class="col-6 offset-3" style="margin-top: 50px;">
        <div class="card">
            ...
            <div class="card-body">
                    <label for="name" class="form-label my-3">{{ trans('globalText.item_category.itemCategoryName') }}</label>
                    <input type="text" name="" id="updateItemName" class="form-control" value="{{ $data->name }}">
                    <label for="description" class="form-label my-3">{{ trans('globalText.item_category.itemCategoryDescription') }}</label>
                    <input type="text" name="" id="updateItemDescription" class="form-control" value="{{ $data->description }}">
