    ...
    <div class="col">
        <div class="card ">
                ...
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="">
                        <a href="{{ route('admin.product.createFoodPage') }}"><button class="btn btn-primary mr-3">{{ trans('globalText.product.add_Food') }}</button></a>
                        <a href="{{ route('admin.product.createItemPage') }}"><button class="btn btn-primary">{{ trans('globalText.product.add_item') }}</button></a>
                    </div>
                </div>
                <div class="card-body">
                        <div class="row">
                                            ...
                                            @foreach ($data as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('admin.product.show',$item->id) }}"><i class="ti-eye mr-3 text-dark"></i></a>
                                                        <a href="{{ route('admin.product.edit',$item->id) }}"><i class="ti-pencil mr-3 text-dark"></i></a>
                                                        <i class="ti-trash text-dark deleteProduct" data-productId="{{ $item->id }}"></i>
                                                    </td>
                                                </tr>
                                            @endforeach
