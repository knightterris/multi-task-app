                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                @if($data->product_type == 0) <span class="badge badge-success">Food</span> @endif
                                @if($data->product_type == 1) <span class="badge badge-success">Item</span> @endif
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                @if($data->status == 0) <span class="badge badge-success">In-stock</span> @endif
                                @if($data->status == 1) <span class="badge badge-danger">Out-of-stock</span> @endif
                            </div>
                        </div>
